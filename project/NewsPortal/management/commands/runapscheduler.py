...
def my_job():
    ...
    categories = set(post.values_list('categories__category_name', flat=True))
    ...
    html_content = render_to_string('post/week_posts.html', {'link': settings.SITE_URL, 'posts': post})
